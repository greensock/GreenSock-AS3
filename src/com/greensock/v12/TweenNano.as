 ...
 * 				 in the com.greensock.v12.easing package, but also standard easing equation that uses the
...
TweenNano.ticker.removeEventListener("tick", myFunction);
		...
		/** Provides An easy way to change the default easing equation. Choose from any of the GreenSock eases in the <code>com.greensock.v12.easing</code> package or any standard easing function like the ones in Adobe's <code>fl.motion.easing</code> package. @default QuadOut.ease **/
		...
		/** @private Easing method to use which determines how the values animate over time. Examples are Elastic.easeOut and Strong.easeIn. Many are found in the fl.motion.easing package or com.greensock.v12.easing. **/
...
TweenNano.to([mc1, mc2, mc3], 1, {x:100});
		 ...
		 * @return com.greensock.v12.TweenNano instance

...
package com.greensock.v12 {
	...
	import com.greensock.v12.events.TweenEvent;
 ...
 * 				 (which are in the <code>com.greensock.v12.easing</code> package). TweenMax also works with
...
TweenMax.to([mc1, mc2, mc3], 1, {x:100});
		 ...
		 * @return com.greensock.v12.TweenMax instance
		 * @see #from()
		 * @see #fromTo()
		 * @see #staggerTo()
...
TweenMax.set([obj1, obj2, obj3], {x:100, y:50, alpha:0});
		 ...
		 * @see com.greensock.v12.TimelineLite#exportRoot()
		 */

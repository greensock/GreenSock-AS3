...
package com.greensock.v12.loading.core {
	...
	[Event(name="open", 	type="com.greensock.v12.events.LoaderEvent")]
	/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
	[Event(name="progress", type="com.greensock.v12.events.LoaderEvent")]
	/** Dispatched when the loader completes. **/
	[Event(name="complete", type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="cancel", 	type="com.greensock.v12.events.LoaderEvent")]
	/** Dispatched when the loader fails. **/
	[Event(name="fail", 	type="com.greensock.v12.events.LoaderEvent")]
	/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
	[Event(name="error", 	type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="unload", 	type="com.greensock.v12.events.LoaderEvent")]
/**

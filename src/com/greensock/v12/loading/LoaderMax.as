 ...
 **/
package com.greensock.v12.loading {
	import com.greensock.v12.events.LoaderEvent;
	import com.greensock.v12.loading.core.LoaderCore;
	import com.greensock.v12.loading.core.LoaderItem;
	...
	[Event(name="childOpen", 			type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="childProgress", 		type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="childComplete", 		type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="childFail", 			type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="childCancel", 			type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="scriptAccessDenied", 	type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="httpStatus", 			type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="ioError", 				type="com.greensock.v12.events.LoaderEvent")]
	...
	[Event(name="securityError", 		type="com.greensock.v12.events.LoaderEvent")]
/**
...
import com.greensock.v12.loading.~~;
import com.greensock.v12.events.LoaderEvent;
import com.greensock.v12.loading.display.~~;
 ...
 * 		<li><strong> onOpen : Function</strong> - A handler function for <code>LoaderEvent.OPEN</code> events which are dispatched when the loader begins loading. Make sure your onOpen function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.v12.events.LoaderEvent</code>).</li>
 * 		<li><strong> onProgress : Function</strong> - A handler function for <code>LoaderEvent.PROGRESS</code> events which are dispatched whenever the <code>bytesLoaded</code> changes. Make sure your onProgress function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.v12.events.LoaderEvent</code>). You can use the LoaderEvent's <code>target.progress</code> to get the loader's progress value or use its <code>target.bytesLoaded</code> and <code>target.bytesTotal</code>.</li>
 * 		<li><strong> onComplete : Function</strong> - A handler function for <code>LoaderEvent.COMPLETE</code> events which are dispatched when the loader has finished loading. Make sure your onComplete function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.v12.events.LoaderEvent</code>).</li>
 * 		<li><strong> onCancel : Function</strong> - A handler function for <code>LoaderEvent.CANCEL</code> events which are dispatched when loading is aborted due to either an error or because another loader was prioritized or <code>cancel()</code> was manually called. Make sure your onCancel function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.v12.events.LoaderEvent</code>).</li>
 ...
 * 		<li><strong> onHTTPStatus : Function</strong> - A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onHTTPStatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.v12.events.LoaderEvent</code>).</li>
 ...
 * 
 * @see com.greensock.v12.loading.data.LoaderMaxVars
 * 
 ...
 */	
	public class LoaderMax extends LoaderCore {		
		...
		/** The class used by ImageLoaders, SWFLoaders, and VideoLoaders to create the containers into which they'll dump their rawContent - by default it is the <code>com.greensock.v12.loading.display.ContentDisplay</code> class but if you're using Flex, it is typically best to change this to <code>com.greensock.v12.loading.display.FlexContentDisplay</code>. You only need to do this once, like
		 * <listing version="3.0">
import com.greensock.v12.loading.LoaderMax;
import com.greensock.v12.loading.display.FlexContentDisplay;
...
import com.greensock.v12.loading.~~;
import com.greensock.v12.loading.core.~~;
import com.greensock.v12.events.LoaderEvent;
...
//---- STATIC METHODS ----------------------------------------------------------------------------
		 ...
		 * 		<li><strong> VideoLoader </strong> - A <code>com.greensock.v12.loading.display.ContentDisplay</code> (a Sprite) which contains the VideoLoader's <code>rawContent</code> (a Video object to which the NetStream was attached).</li>
		 * 		<li><strong> XMLLoader </strong> - XML</li>
		 * 		<li><strong> DataLoader </strong>
		 * 			<ul>
		 * 				<li><code>String</code> if the DataLoader's <code>format</code> vars property is <code>"text"</code> (the default).</li>
